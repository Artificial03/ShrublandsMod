...
{
    public class JarrahWoodChair : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            // Names
            AddMapEntry(new Color(215, 78, 52), Language.GetText("MapObject.Chair"));
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeable.JarrahWoodChair>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Items.Placeable.JarrahWoodChair>();
